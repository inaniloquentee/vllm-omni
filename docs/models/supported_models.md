...
| `JanusPipeline` | DeepSeek Janus (text-to-image, diffusion stage) | `deepseek-ai/Janus-1.3B` | ✅︎ | ✅︎ | | |
| `MultiModalityCausalLM` | DeepSeek Janus (AR stage; Llama subtree only) | `deepseek-ai/Janus-1.3B` (two-stage topology) | ✅︎ | ✅︎ | | |
