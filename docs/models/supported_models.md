...
| `JanusPipeline` | DeepSeek Janus (single-stage text-to-image, and stage 1 of the two-stage topology) | `deepseek-ai/Janus-1.3B` | ✅︎ | ✅︎ | | |
| `MultiModalityCausalLM` | DeepSeek Janus (stage 0 AR text generation; Llama subtree only) | `deepseek-ai/Janus-1.3B` (two-stage topology) | ✅︎ | ✅︎ | | |
